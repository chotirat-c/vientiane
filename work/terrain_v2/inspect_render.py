...
with Image.open(p) as im:
    im.crop((1700,1600,2900,2800)).save(OUT/(stem+'_qa_terrain.png'))
    im.crop((450,6400,2900,7390)).save(OUT/(stem+'_qa_labels.png'))
    if args.style=='green-paper':
        im.crop((250,2800,1300,3850)).save(OUT/'green_qa_paper.png')
