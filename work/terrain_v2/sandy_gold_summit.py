...
scene.render.filepath=str(ROOT/'outputs/laos_relief_contour_sandy_gold_8k.png')
bpy.ops.wm.save_as_mainfile(filepath=str(ROOT/'outputs/laos_relief_contour_sandy_gold_8k.blend'),compress=True)
...
scene.render.filepath=str(ROOT/'outputs/laos_relief_contour_sandy_gold_preview.png')
